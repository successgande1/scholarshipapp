...
urlpatterns = [
    ...
    path('applicants/search/', user_view.search_applicants, name = 'search-applicant'),
    path('<int:pk>/applicant/approval/', user_view.approve_applicant, name = 'approve-applicant'),
